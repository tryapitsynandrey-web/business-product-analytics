...
class TestContractValidation:
    def test_valid_metric_contract_passes(self, governance, minimal_datasets):
        result = governance.validate_metric_contract(
            "monthly_recurring_revenue", minimal_datasets
        )
    ...
    def test_missing_metric_returns_error_issue(self, governance, minimal_datasets):
        result = governance.validate_metric_contract(
            "nonexistent_metric_xyz", minimal_datasets
        )
    ...
    def test_validate_metric_convenience_wrapper_returns_bool(
        self, governance, minimal_datasets
    ):
        passed = governance.validate_metric(
            "monthly_recurring_revenue", minimal_datasets
        )
